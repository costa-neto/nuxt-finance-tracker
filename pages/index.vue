<template>
  ...
  <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
    ...
    <Trend color="red" title="Savings" :amount="4000" :last-amount="4100" :loading="isLoading" />
  </section>
  ...
  <section class="flex justify-between mb-10">
    <div>
      ...
      <div class="text-gray-500 dark:text-gray-400">
        You have {{ incomeCount }} incomes and {{ expenseCount }} expense in this period.
      </div>
    </div>
    <div>
...
const incomeTotal = computed(
  () => income.value.reduce(((acc, cur) => acc + cur.amount), 0)
)

const expenseTotal = computed(
  () => expense.value.reduce(((acc, cur) => acc + cur.amount), 0)
)
